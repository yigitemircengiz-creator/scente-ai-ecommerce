...
That's it. All images (bottle photos, backgrounds, logo) are embedded directly inside `index.html` as base64 data URLs. No external files, no CDN dependencies, no internet connection required after the initial font load.
